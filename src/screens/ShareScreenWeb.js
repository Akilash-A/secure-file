    ...
    >
          ...
          >
            ...
            {sharedFiles.map((file) => (
              <View key={file.id} style={[styles.sharedFileCard, { backgroundColor: isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(67, 233, 123, 0.1)' }]}>
                ...
                <TouchableOpacity 
                  onPress={() => copyToClipboard(file.code)}
      ...
      <Portal>
        ...
        >
          ...
          >
            <Text style={styles.modalTitle}>🎉 File Shared Successfully!</Text>
          </LinearGradient>
          
          <View style={styles.modalContent}>
            <Text style={[styles.modalText, { color: theme.colors.onSurface }]}>
              Your file has been shared with the code:
            </Text>
            <View style={[styles.codeContainer, { backgroundColor: isDarkMode ? 'rgba(67, 233, 123, 0.2)' : 'rgba(67, 233, 123, 0.1)' }]}>
              <Text style={[styles.codeText, { color: '#43e97b' }]}>{shareCode}</Text>
              <TouchableOpacity 
            ...
            <Text style={[styles.modalNote, { color: theme.colors.onSurfaceVariant }]}>
              Share this code with others to let them download your file. The link will expire based on your selected time.
            </Text>
          </View>
          ...
          <View style={styles.modalActions}>
            <TouchableOpacity 
              ...
              onPress={resetForm}
            >
              <Text style={styles.modalButtonText}>Share Another File</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.modalButton, { backgroundColor: theme.colors.outline }]}
              onPress={() => setIsModalVisible(false)}
            >
              <Text style={[styles.modalButtonText, { color: theme.colors.onSurface }]}>Close</Text>
            </TouchableOpacity>
          </View>
        </Modal>
      </Portal>
